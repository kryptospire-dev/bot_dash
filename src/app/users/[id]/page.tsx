...
import { Calendar, Clock, Bot, Instagram, Twitter, CheckCircle, XCircle, User as UserIcon, Wallet, Send, ArrowLeft, Gift, Hash, Users, DollarSign, Loader2 } from 'lucide-react';
...
export default function UserProfilePage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(userDocRef, (docSnap) => {
      ...
      console.error(`Error fetching user ${params.id} in real-time:`, error);
      toast({
        variant: "destructive",
  ...
  return (
    <div className="container mx-auto max-w-4xl p-4 md:p-8 animate-fadeIn">
        <div className="mb-4">
                 ...
                 <Card className="p-4">
                        ...
                        {canSendReferralReward && (
                             <AlertDialog>
                                ...
                                <AlertDialogContent>
                                    ...
                                    <AlertDialogDescription>
                                        You are about to send a referral reward of <span className="font-bold">{totalReferrals} MNTC</span> for <span className="font-bold">{totalReferrals} successful referrals</span>.
                                        This action will update the user's "Referral Rewards" to match their "Total Referrals".
                                    </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
                    ...
                    <CardContent className="space-y-3 p-2">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold">{totalRewards} MNTC</span>
                        </div>
                         <div className="flex items-center gap-3">
